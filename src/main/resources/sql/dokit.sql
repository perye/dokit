...
-- Records of dept
-- ----------------------------
INSERT INTO `dept` VALUES (1, 'dokit', 0, '2019-03-25 09:14:05', b'1');
...
INSERT INTO `dept` VALUES (13, '管理员部门', 1, '2019-10-20 09:59:02', b'1');
INSERT INTO `dept` VALUES (14, '测试部', 1, '2019-10-20 09:59:13', b'1');
...
-- ----------------------------
INSERT INTO `email_config` VALUES (1, '11143526@qq.com', 'smtp.qq.com', 'vylyvstucpscbihe\n', '465', 'dokit1');
...
-- ----------------------------
INSERT INTO `gen_config` VALUES (1, 'perye', b'1', 'com.perye.dokit', 'E:\\perye\\project\\dokit\\dokit-front\\src\\views\\test', 'E:\\perye\\project\\dokit\\dokit-front\\src\\api', NULL);
...
-- Records of job
-- ----------------------------
INSERT INTO `job` VALUES (2, '测试人员', b'1', '2019-03-29 14:01:30', 2, 14);
INSERT INTO `job` VALUES (19, '超级管理员', b'1', '2019-03-31 14:58:15', 1, 13);
...
CREATE TABLE `knowledge`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `text` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '搜索文本',
  `count` int(11) NULL DEFAULT NULL COMMENT '搜索次数',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '首次搜索时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '最近搜索时间',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `menu` VALUES (10, '2018-12-19 13:38:16', b'0', '组件管理', NULL, 0, 20, 'zujian', 'components', b'0', b'0', NULL);
...
INSERT INTO `menu` VALUES (36, '2019-03-29 10:57:35', b'0', '系统工具', '', 0, 30, 'sys-tools', 'sys-tools', b'0', b'0', NULL);
...
INSERT INTO `menu` VALUES (42, '2019-10-22 09:22:35', b'0', '其他', '', 0, 999, 'tools', 'other', b'0', b'0', '');
INSERT INTO `menu` VALUES (43, '2019-10-22 09:26:52', b'0', '知识图谱', 'other/knowledge/index', 42, 1, 'dev', 'knowledge', b'0', b'0', 'Knowledge');
...
INSERT INTO `quartz_job` VALUES (3, 'testTask', '0/5 * * * * ?', b'1', '测试', 'run', '', '不带参测试', '2019-10-19 11:35:50');
...
INSERT INTO `roles_menus` VALUES (42, 4);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, NULL, '2018-08-23 09:11:56', 'admin@dokit.com', 1, 'e10adc3949ba59abbe56e057f20f883e', 'admin', '2019-05-18 17:34:21', 13, '18888888888', 19);
INSERT INTO `user` VALUES (3, NULL, '2018-12-27 20:05:26', 'test@dokit.com', 1, 'e10adc3949ba59abbe56e057f20f883e', 'test1', '2019-04-01 09:15:24', 14, '17777777727', 2);
INSERT INTO `user` VALUES (6, NULL, '2019-10-20 10:01:47', 'test2@dokit.com', 1, 'e10adc3949ba59abbe56e057f20f883e', 'test2', NULL, 14, '15759112154', 2);
